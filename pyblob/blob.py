...
class BlobBase:
        ...
        if connect_string:
            ...
            if protocal and account_name and account_key:
                ...
                if host and (blob_port or queue_port or table_port):
                    ...
                    raise TypeError(f"At least required argument: ['host', ('blob_port', 'queue_port', 'table_port')] or ['endpoint_suffix']")
            else:
                raise TypeError(f"At least required argument: 'connect_string' or ['protocal', 'account_name', 'account_key']")
    ...
    def init_container_service_client(self, container_name:str):
        ...
        self.__container_name = container_name
        self.container_client = self.blob_service_client.get_container_client(self.__container_name)
...
class BlobAsync(BlobBase):
    def __init__(self, connect_string:str=None, protocal:Protocal=Protocal.https, host:str=None, account_name:str=None, account_key:str=None, 
        ...
        super(BlobAsync, self).__init__(connect_string=connect_string, protocal=protocal, host=host, blob_port=blob_port, queue_port=queue_port, table_port=table_port, account_name=account_name, account_key=account_key,**kwargs)
...
class BlobSync(BlobBase):
    def __init__(self, connect_string:str=None, protocal:Protocal=Protocal.https, host:str=None, account_name:str=None, account_key:str=None, 
                 blob_port:Union[str,int]=None, queue_port:Union[str,int]=None, table_port:Union[str,int]=None, **kwargs) -> None:
        super(BlobSync, self).__init__(connect_string=connect_string, protocal=protocal, host=host, blob_port=blob_port, queue_port=queue_port, table_port=table_port, account_name=account_name, account_key=account_key,**kwargs)
...
class Blob:
    def __init__(self, connect_string:str=None, protocal:Protocal=Protocal.https, host:str=None, account_name:str=None, account_key:str=None, 
        ...
        if self.isasync:
            self.blob = BlobAsync(connect_string=connect_string, protocal=protocal, host=host, blob_port=blob_port, queue_port=queue_port, table_port=table_port, account_name=account_name, account_key=account_key,*args,**kwargs)
        else:
            self.blob = BlobSync(connect_string=connect_string, protocal=protocal, host=host, blob_port=blob_port, queue_port=queue_port, table_port=table_port, account_name=account_name, account_key=account_key,*args,**kwargs)        
    ...
    def container_exists(self):
        if self.isasync: return self.blob.list_container()
